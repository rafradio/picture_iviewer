...
/* GEH */
var deg = this.options.angle*1;
if (deg===null || deg < -270 || deg > 270 || deg % 90 !== 0) { 
    this.start_angle = 0;
} else {
    this.start_angle=deg;
}
...
if (this.start_angle!==null){
    this.img_object.angle(this.start_angle,true);
    ...
    **/
    createui: function()
    {
        ...
        this.zoom_controls = $("<div>").addClass("iviewer_background")
                                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_in iviewer_common iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(this.zoom_controls);
...
//        document.getElementById("angle").value = document.getElementById("angle").value*1 + deg;
        document.getElementById("angle").value = /* document.getElementById("angle").value*1 */ deg;
    }
